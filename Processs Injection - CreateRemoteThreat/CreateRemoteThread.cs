    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            //Not using PAGE_EXECUTE_READWRITE because is a Redflag for many AVs
            ...
            Console.WriteLine("[*] Allocating RW memory at: 0x" + String.Format("{0:X}", (addr).ToInt64()));
            ...
            Console.WriteLine("[+] Shellcode copied to the reserved memory");
            ...
            Console.WriteLine("[+] Setting the allocated memory as RX");
